const CACHE='thetis-v2.5.8';
const SHELL=['./','./index.html','./styles.css?v=2.5.8','./app.js?v=2.5.8','./manifest.webmanifest','./version.json','./database/THETIS_Database_MASTER.xlsx','./icons/icon-192.png','./icons/icon-512.png'];
