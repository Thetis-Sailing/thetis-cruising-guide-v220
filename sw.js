const CACHE='thetis-v2.5.4';
const SHELL=['./','./index.html','./styles.css?v=2.5.4','./app.js?v=2.5.4','./manifest.webmanifest','./version.json','./database/THETIS_Database_MASTER.xlsx','./icons/icon-192.png','./icons/icon-512.png'];
